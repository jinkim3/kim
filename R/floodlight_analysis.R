...
floodlight_analysis <- function(
  ...
  if (is.null(iv_1_name)) {
    stop(paste0(
      "No input for iv_1_name. Please enter the name of ",
      "the first independent variable."))
  }
  if (is.null(dv_name)) {
    stop(paste0(
      "No input for dv_name. Please enter the name of ",
      "the dependent variable."))
  }
  # study designs
  # from Table 1 of Spiller et al. 2013
  # Spotlights, Floodlights, and the Magic Number Zero
  # 1. 2 x continuous
  # 2. 2 (within) x continuous
  # 3. 2 x 2 x continuous
  # 4. 3 x continuous
  # 5. continuous x continuous
